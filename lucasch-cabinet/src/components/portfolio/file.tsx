...
const File = ({ tabLocation, children, isDivider = false, index }: Props) => {
    ...
    return (
        <div className="perspective-[1000px]">
            <motion.div
                ...
                onDragEnd={() => {
                    if (dragY < dragConfig.dragConstraintTop / 2) {
                        setIsOpen(true);
                    } else {
                        setIsOpen(false);
                    }
                ...
                animate={{ y: isOpen ? dragConfig.dragConstraintTop : 0 }}
                className={cn(
            ...
            >
                ...
                >
                    <div className="relative flex h-full w-full cursor-pointer items-center justify-center">
                        ...
                        <div
                            className={cn(
                                "absolute flex w-[145px] justify-center text-[1.05rem] font-medium tracking-[2px]",
